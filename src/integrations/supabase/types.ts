  ...
  public: {
    Tables: {
      ...
      clearance_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "clearance_files_clearance_request_id_fkey"
            columns: ["clearance_request_id"]
            isOneToOne: false
      ...
      clearance_signatures: {
        ...
        Relationships: [
          {
            foreignKeyName: "clearance_signatures_clearance_request_id_fkey"
            columns: ["clearance_request_id"]
            isOneToOne: false
            referencedRelation: "clearance_requests"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "clearance_signatures_signatory_id_fkey"
    ...
    Enums: {
      ...
      clearance_status: "pending" | "in_progress" | "approved" | "rejected"
    }
    CompositeTypes: {
      [_ in never]: never
    }
